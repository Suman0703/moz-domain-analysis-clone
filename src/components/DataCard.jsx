  ...
  return (
    <div className="bg-[#F4F7F9] px-4 md:px-6 lg:px-8 pb-12">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8">
        ...
        {/* ROW 1: Links & Domains */}
        <DataCard title="Top Pages by Links" description="The most important pages on mozilla.org based on Page Authority (PA)." col1Header="Page/URL" col2Header="PA" data={topPagesData} />
        <DataCard title="Top Linking Domains" description="The top linking domains to mozilla.org based on Domain Authority (DA)." col1Header="Domain" col2Header="DA" data={topDomainsData} />
        ...
        {/* ROW 6: Keyword CTA */}
        <CtaBanner title="Want more keyword data?" subtitle="Get instant access to our database of over 500 million keywords." buttonText="Try Moz Pro Free" />
        ...
        <div className="md:col-span-2">
          <DataCard title="Top Questions" description="Top questions mined from People Also Ask boxes." col1Header="Question" col2Header="Relevance" data={topQuestionsData} isLink={false} />
        </div>

        {/* ROW 9: Final CTA */}
        <CtaBanner title="Ready to get started for free?" subtitle="Make data-driven decisions to propel your search strategy." buttonText="Check Domain Authority" />
